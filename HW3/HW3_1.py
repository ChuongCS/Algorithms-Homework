# -*- coding: utf-8 -*-
"""
Created on Mon Nov 13 23:27:26 2017
...
class AugmentedRedBlackTree:
    ...
    def Delete(self, value):
        ...
        if node_to_Delete.get_children_count() == 2:
            ...
            node_to_Delete.value = successor.value  # switch the value
    ...
    def _Delete(self, node):
        ...
        if node == self.root:
            ...
            if not_nil_child.color == RED:
                """
                Swap the values with the red child and Delete it  (basically un-link it)
